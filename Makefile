all: program
	./flowshopWCT --all assets/instances/
program :
	...
	g++ -std=c++17 -O3 -c ./src/flowshop.cpp -o bin/flowshop.o
	g++ -std=c++17 -O3 bin/flowshop.o bin/random_permutation.o bin/simplified_rz.o bin/first_improvement.o bin/best_improvement.o bin/insert.o bin/exchange.o bin/transpose.o bin/context.o bin/pfspinstance.o bin/iterative_improvement.o bin/variable_neighbourhood_descent.o -o flowshopWCT
clean:
